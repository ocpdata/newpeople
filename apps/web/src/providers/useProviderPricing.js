...
export function useProviderPricing({
  ...
  return {
    ...
    editingProviderPriceListId: priceLists.editingProviderPriceListId,
    editingProviderPriceList: priceLists.editingProviderPriceList,
    ...
    openEditProviderPriceListModal: priceLists.openEditProviderPriceListModal,
