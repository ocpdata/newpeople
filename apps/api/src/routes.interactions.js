      ...
      z.object({
        ...
        draft: z
          .object({
            ...
            phone: z.string().trim().max(40).optional().default(""),
            phoneExtension: z.string().trim().max(20).optional().default(""),
...
async function createContactFromDraft(conn, user, accountId, draft) {
  ...
  const [
    ...
    getIdByCode("contact_hierarchy_levels", "usuario"),
    getIdByCode("contact_influence_levels", "media"),
